      ...
      <div className="p-6 flex-1 max-w-3xl mx-auto w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <select
              className="cursor-pointer mt-1 block w-full p-3 border border-gray-300 rounded-lg shadow-sm"
              value={nationality}
        ...
        <button
          className="cursor-pointer w-full mt-6 py-3 bg-yellow-400 text-gray-900 font-bold rounded-xl shadow-md hover:bg-yellow-500 flex items-center justify-center"
          onClick={() => showScreen("visaResult")}>
          Check Requirements
        </button>
        <p className="text-center text-sm text-gray-500 mt-3">
          Mock result based on selected countries.
        </p>
      </div>
    </div>
  );
