      ...
      <div className="relative mx-4 w-full max-w-md overflow-hidden rounded-3xl bg-white/90 dark:bg-gray-900/90 backdrop-blur ring-1 ring-black/10 dark:ring-white/10 shadow-[0_20px_80px_rgba(0,0,0,0.25)]">
        ...
        <div className="p-5">
          ...
          <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
            Auto reminders, 20GB secure storage, Google Calendar sync, and
            priority support.
          </p>
...
const LatestDealCard: React.FC<{ deal: Deal }> = ({ deal }) => (
  <div
    ...
    <div className="mb-1 text-lg font-semibold text-gray-900 dark:text-white">
      {deal.from}{" "}
      <ArrowRight className="mx-1 inline h-4 w-4 text-gray-400 dark:text-gray-500" />{" "}
      {deal.to}
    </div>
    ...
    <div className="mt-3 h-10 w-full rounded-lg bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-gray-700 dark:to-purple-900 ring-1 ring-black/5 dark:ring-white/10">
      <svg
        viewBox="0 0 100 30"
        className="h-full w-full text-indigo-500 dark:text-indigo-400">
        <path
...
const RoundTripCard: React.FC<{ item: RoundTrip; onSearch?: () => void }> = ({
  ...
  <div
    ...
    <div className="mb-2 flex items-baseline gap-2">
      <div className="text-3xl font-extrabold text-indigo-600 drop-shadow-sm dark:text-indigo-400">
        {item.days}
      </div>
      <div className="text-sm font-semibold text-indigo-400 dark:text-indigo-500">
        Day Trip
      </div>
    </div>

    <div className="mb-1 text-[15px] font-semibold text-gray-900 dark:text-white">
      {item.rangeText}
    </div>
    ...
    <div className="flex items-center justify-between">
      <div className="text-[15px] font-bold text-indigo-600 dark:text-indigo-400">
...
const DashboardScreen: React.FC<ScreenProps> = ({
  ...
  return (
    <div
      className={`${
        isDarkMode ? "dark" : ""
      } relative flex min-h-screen flex-col bg-gradient-to-br ${
